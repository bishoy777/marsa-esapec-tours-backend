...
export class CreateReviewTable1775156192070 implements MigrationInterface {
    name = 'CreateReviewTable1775156192070'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "trip_day" ("id" SERIAL NOT NULL, "dayNumber" integer NOT NULL, "morning" text array NOT NULL DEFAULT '{}', "afternoon" text array NOT NULL DEFAULT '{}', "evening" text array NOT NULL DEFAULT '{}', "tripId" integer, CONSTRAINT "PK_22c09bc2360526eb49095589b59" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "trip" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "date" TIMESTAMP NOT NULL, "included" text array NOT NULL DEFAULT '{}', "excluded" text array NOT NULL DEFAULT '{}', "price" numeric(10,2) NOT NULL, "tripTypeId" integer, CONSTRAINT "PK_714c23d558208081dbccb9d9268" PRIMARY KEY ("id"))`);
